...
if(ENABLE_CURSES)
    ...
    set(HAVE_NCURSES 1)
    set(EC_INTERFACES_LIBS ${EC_INTERFACES_LIBS} ${CURSES_LIBRARIES} ${CURSES_NCURSES_LIBRARY} ${CURSES_FORM_LIBRARY})
    #set(EC_LIBS ${EC_LIBS} ${CURSES_LIBRARIES} ${CURSES_NCURSES_LIBRARY} ${CURSES_FORM_LIBRARY})
...
if(HAVE_GEOIP)
   set(WITH_GEOIP 1)
   set(EC_LIBS ${EC_LIBS} ${HAVE_GEOIP})
endif(HAVE_GEOIP)
# begin LIBNET 
