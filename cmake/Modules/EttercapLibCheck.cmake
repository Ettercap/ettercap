...
if(ENABLE_CURSES)
  ...
  set(HAVE_NCURSES 1)
  set(EC_UI_LIBS ${EC_UI_LIBS} ${CURSES_LIBRARIES})
  set(EC_UI_INCLUDE ${EC_UI_INCLUDE} ${CURSES_INCLUDE_DIRS})

  if(CURSES_HAVE_NCURSES_NCURSES_H)
    set(EC_UI_INCLUDE ${EC_UI_INCLUDE} ${CURSES_INCLUDE_DIRS}/ncurses)
  endif()
  ...
  if(CURSES_PANEL_LIBRARY AND CURSES_MENU_LIBRARY)
    set(EC_UI_LIBS ${EC_UI_LIBS} ${CURSES_PANEL_LIBRARY} ${CURSES_MENU_LIBRARY})
...
Please install it, or build against GTK2")
    ...
    set(EC_UI_INCLUDE ${EC_UI_INCLUDE} ${GTK3_INCLUDE_DIRS})
  endif()
  if(GTK_BUILD_TYPE STREQUAL GTK2)
    ...
    set(HAVE_GTK 1)
    set(EC_UI_LIBS ${EC_UI_LIBS} ${GTK2_LIBRARIES})
    set(EC_UI_INCLUDE ${EC_UI_INCLUDE} ${GTK2_INCLUDE_DIRS})
  endif()
  if(OS_DARWIN OR OS_BSD)
    find_library(FOUND_GTHREAD gthread-2.0)
    if(FOUND_GTHREAD)
      set(EC_UI_LIBS ${EC_UI_LIBS} ${FOUND_GTHREAD})
    endif()
  else()
    set(EC_UI_LIBS ${EC_UI_LIBS} gthread-2.0)
  endif()
endif()
...
if(CMAKE_USE_PTHREADS_INIT)
  ...
  if(OS_WINDOWS)
    ...
    if(PTHREADS-WIN32_FOUND)
      set(EC_LIBS ${EC_LIBS} ${PTHREADS-WIN32_LIBRARY})
      set(EC_INCLUDE ${EC_INCLUDE} ${PTHREADS-WIN32_INCLUDE_DIR})
      set(EC_DEFINITIONS ${EC_DEFINITIONS} ${PTHREADS-WIN32_DEFINITIONS})
    else()
...
if(PCAP_LIBRARIES AND PCAP_INCLUDE_DIRS)
  set(EC_LIBS ${EC_LIBS} ${PCAP_LIBRARIES})
  set(EC_INCLUDE ${EC_INCLUDE} ${PCAP_INCLUDE_DIRS})
...
if(PCRE_FOUND)
  set(HAVE_PCRE 1)
  set(EC_INCLUDE ${EC_INCLUDE} ${PCRE_INCLUDE_DIRS})
  set(EC_LIBS ${EC_LIBS} ${PCRE_LIBRARIES})
endif()
  ...
  if(BUNDLED_LIBCHECK AND (NOT LIBCHECK_FOUND))
    ...
    if(NOT OS_DARWIN AND (NOT LIB_RT))
      message(FATAL_ERROR "Could not find librt, \
        which is required for linking tests.")
    endif()
  endif()
