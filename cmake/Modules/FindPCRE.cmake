...
if(PCRE_FIND_VERSION)
  ...
  if(EXISTS ${HEADER_FILE})
    ...
    set(PCRE_VERSION_STRING
      "${PCRE_VERSION_STRING_MAJOR}.${PCRE_VERSION_STRING_MINOR}"
    )
...
Version ${PCRE_VERSION_STRING} was found, \
version ${PCRE_FIND_VERSION} is needed exactly."
        )

      else()
        message(FATAL_ERROR "PCRE version check failed.
Version ${PCRE_VERSION_STRING} was found, \
at least version ${PCRE_FIND_VERSION} is required"
        )
...
find_package_handle_standard_args(PCRE
  DEFAULT_MSG PCRE_LIBRARY PCRE_INCLUDE_DIR
)
