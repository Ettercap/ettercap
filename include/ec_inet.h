...
#define ETH_ASCII_ADDR_LEN      sizeof("ff:ff:ff:ff:ff:ff")+1
#define IP_ASCII_ADDR_LEN       sizeof("255.255.255.255")+1
#define IP6_ASCII_ADDR_LEN      sizeof("ffff:ffff:ffff:ffff:ffff:ffff:255.255.255.255")+1
