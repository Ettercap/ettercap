...
GtkItemFactoryEntry gmenu_view[] = {
   ...
   {"/View/sep1",                    NULL, NULL,                   0, "<Separator>", 0 },
   {"/View/Resolve IP addresses",    NULL, toggle_resolve,         0, "<ToggleItem>", 0 },
...
GtkItemFactoryEntry gmenu_mitm[] = {
   {"/_Mitm",                    NULL, NULL,                0, "<Branch>", 0 },
   {"/Mitm/Arp poisoning...",    NULL, gtkui_arp_poisoning, 0, "<Item>", 0 },
   {"/Mitm/Icmp redirect...",    NULL, gtkui_icmp_redir,    0, "<Item>", 0 },
   {"/Mitm/Port stealing...",    NULL, gtkui_port_stealing, 0, "<Item>", 0 },
   {"/Mitm/Dhcp spoofing...",    NULL, gtkui_dhcp_spoofing, 0, "<Item>", 0 },
   {"/Mitm/sep1",                NULL, NULL,                0, "<Separator>", 0 },
...
GtkItemFactoryEntry gmenu_logging[] = {
   ...
   {"/Logging/sep1",                         NULL, NULL,            0, "<Separator>", 0 },
   ...
   {"/Logging/sep2",                         NULL, NULL,            0, "<Separator>", 0 },
   {"/Logging/Compressed file",              NULL, toggle_compress, 0, "<ToggleItem>", 0 }
};

GtkItemFactoryEntry gmenu_plugins[] = {
   {"/_Plugins",                   NULL,         NULL,              0, "<Branch>", 0 },
